...
def parse_args():
    ...
    parser.add_argument('--origin-dir', default='/workspace/Code/datasets/UCF-QNRF_ECCV18',
                        help='original data directory')
    parser.add_argument('--data-dir', default='/workspace/UCF_Train_Val_Test',
    ...
    for phase in ['Train', 'Test']:
        ...
        if phase == 'Train':
            ...
            for sub_phase in sub_phase_list:
                ...
                with open('/workspace/Code/ucf_{}.txt'.format(sub_phase)) as f:
                    for i in f:
