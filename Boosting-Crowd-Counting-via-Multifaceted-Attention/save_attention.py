...
def parse_args():
    ...
    parser.add_argument('--data-dir', default='/workspace/UCF_Train_Val_Test/train/img_1148.jpg',
                        help='training data directory')
    parser.add_argument('--model-path', default=r'/workspace/Code/models/model.pth',
